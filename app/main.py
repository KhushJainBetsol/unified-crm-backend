...
#     set_app,               # ← NEW: lets the scheduler reach app.state.adapter_factory
#     start_scheduler,
#     stop_scheduler,
# )
# from app.utils.exceptions import register_exception_handlers
...
#     # Wire the app reference into the scheduler BEFORE the initial sync
#     # and BEFORE start_scheduler() — the scheduler needs app.state.adapter_factory
#     # for every sync run (initial + all scheduled runs).
#     set_app(app)                          # ← NEW
