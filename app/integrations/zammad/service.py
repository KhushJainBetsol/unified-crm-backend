...
from app.integrations.normalizer.zammad_normalizer import normalize_zammad_tickets
...
class ZammadService:
    ...
    def normalize_raw_tickets(
        ...
        Args:
            raw_tickets: Raw ticket dicts returned by ZammadClient.

        Returns:
            List of NormalizedTicket objects.
        """
        normalized = normalize_zammad_tickets(raw_tickets)
        logger.info(
